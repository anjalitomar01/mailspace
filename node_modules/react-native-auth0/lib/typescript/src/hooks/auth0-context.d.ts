...
export interface Auth0ContextInterface<TUser extends User = User> extends AuthState<TUser> {
     ...
     */
    authorizeWithPasswordRealm: (parameters: PasswordRealmOptions) => Promise<Credentials | undefined>;
    /**
     * Authorize user with credentials using the Password Realm Grant. See {@link Auth#passwordRealm}
     */
    authorizeWithExchangeNativeSocial: (parameters: ExchangeNativeSocialOptions) => Promise<Credentials | undefined>;
    /**
