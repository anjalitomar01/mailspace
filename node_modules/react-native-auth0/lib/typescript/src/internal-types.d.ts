...
export type Auth0Module = {
    ...
    hasValidAuth0InstanceWithConfiguration: (clientId: String, domain: String) => Promise<boolean>;
    initializeAuth0WithConfiguration: (clientId: string, domain: string, localAuthenticationOptions?: LocalAuthenticationOptions) => Promise<void>;
};
