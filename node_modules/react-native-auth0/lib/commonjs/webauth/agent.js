...
class Agent {
  async login(parameters, options, localAuthenticationOptions) {
    ...
    return new Promise(async (resolve, reject) => {
      ...
      try {
        await (0, _nativeHelper._ensureNativeModuleIsInitializedWithConfiguration)(A0Auth0, parameters.clientId, parameters.domain, localAuthenticationOptions);
  ...
  async cancelWebAuth(parameters, localAuthenticationOptions) {
    ...
    await (0, _nativeHelper._ensureNativeModuleIsInitializedWithConfiguration)(_reactNative.NativeModules.A0Auth0, parameters.clientId, parameters.domain, localAuthenticationOptions);
