...
class WebAuth {
  ...
  authorize(parameters = {}, options = {}) {
    ...
    let presentationStyle = options.useSFSafariViewController ? options.useSFSafariViewController?.presentationStyle ?? _types.SafariViewControllerPresentationStyle.fullScreen : undefined;
    return agent.login({
      clientId,
      domain
    }, {
...
var _default = exports.default = WebAuth;
