...
import { AndroidConfig, createRunOncePlugin, withAppDelegate, withInfoPlist, withAndroidManifest } from 'expo/config-plugins';
...
export const addAndroidAuth0Manifest = (auth0Configs, manifest, applicationId) => {
  ...
  const mainApplication = AndroidConfig.Manifest.getMainApplicationOrThrow(manifest.modResults);
